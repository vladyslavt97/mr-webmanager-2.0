...
export default function Header({}: Props) {
  return (
    <div className='bg-green-600/60 sticky flex justify-evenly items-center text-sm text-center font-bold shadow-lg'>
        <Link href="https://maxim-rysanov.vercel.app/concerts" target="_blank" className='m-2 px-4 py-2 rounded-lg border-2 border-red-400 bg-red-300 drop-shadow-lg'>Real Page</Link>
        <AddConcert />
